	...
	local char_map = {
		...
		mc_jewlerystorelvl = {
			...
			list = {
				...
				"ene_mc_swat_2",
				"ene_mc_swat_heavy_1",
				"ene_mc_swat_heavy_r870",
				"ene_mc_tazer_1",
				"ene_mc_zeal_bulldozer",
				"ene_mc_zeal_bulldozer_2",
				"ene_mc_zeal_bulldozer_3",
				"ene_mc_zeal_swat",
				"ene_mc_zeal_swat_heavy",
				"ene_mc_zeal_swat_shield"
			}
		}
	}
